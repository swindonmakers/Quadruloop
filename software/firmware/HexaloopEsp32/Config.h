...
//uint8_t servoCenters[NUM_JOINTS] = {96,93,100,96,82,83,75,85,88,83,90,90,107,88,70,90,115,97};
// RL: calibration
uint8_t servoCenters[NUM_JOINTS] = {108,90,100, 101,90,90, 85,90,90, 90,90,90, 107,93,76, 85,90,90};
